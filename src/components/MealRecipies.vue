import <template>
  ...
  <form class="d-flex" @submit.prevent="searchMeal()">
    <input class="form-control mr-sm-2" type="search" v-model="searchItem" placeholder="Search" aria-label="Search">
...
<script>
import { getRandomMeal,getMealBySearchName } from '../store/Meal.js';
